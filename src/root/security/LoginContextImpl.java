 ...
 */
public class LoginContextImpl extends LoginModuleImpl {
     ...
     */
    public LoginContextImpl(String name) throws LoginException {
        init(name);
     ...
     *          AuthPermission("createLoginContext.other")
     */
    public LoginContextImpl(String name, Subject subject)
     ...
     *          AuthPermission("createLoginContext.other")
     */
    public LoginContextImpl(String name, CallbackHandler callbackHandler)
            throws LoginException {
        init(name);
